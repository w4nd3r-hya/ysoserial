...
@Dependencies()
@ysoserial.payloads.annotation.Authors({ysoserial.payloads.annotation.Authors.PWNTESTER, Authors.w4})
public class Jdk8u20 implements ObjectPayload<Object> {
    ...
    public static boolean isApplicableJavaVersion() {
        ysoserial.payloads.util.JavaVersion v = JavaVersion.getLocalVersion();
